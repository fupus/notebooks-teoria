...
### Referencia
Este repositorio contiene el material de la asignatura "Fundamentos de Programación" impartida por el Departamento de Lenguajes y Sistemas Informáticos (Universidad de Sevilla)

[artículo](http://www.aenui.net/ojs/index.php?journal=actas_jenui&page=article&op=view&path%5B%5D=430&path%5B%5D=632)
